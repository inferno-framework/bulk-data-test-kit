    ...
    class BulkDataPatientTestGroup < Inferno::TestGroup
      ...
      group from: :bulk_data_patient_export_group,
            ...
            config: {
              ...
              children.find { |child| child.id.ends_with?('bulk_data_patient_output_check') }
              ...
              children.find { |child| child.id.ends_with?('bulk_data_patient_status_check') }
              ...
              children.find { |child| child.id.ends_with?('bulk_data_patient_kick_off') }
