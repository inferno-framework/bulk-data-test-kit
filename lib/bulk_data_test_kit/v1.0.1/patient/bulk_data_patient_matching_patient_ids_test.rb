...
module BulkDataTestKit
  module BulkDataV101
    class BulkDataPatientMatchingPatientIDsTest < Inferno::Test
      include BulkDataTestKit::BulkExportValidationTester

      id :bulk_data_patient_matching_patient_ids

      title 'Patient IDs match those expected in Patient Export'
