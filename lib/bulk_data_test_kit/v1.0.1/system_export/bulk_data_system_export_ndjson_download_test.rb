...
module BulkDataTestKit
  module BulkDataV101
    class BulkDataSystemExportNDJSONDownloadTest < Inferno::Test
      include BulkDataTestKit::BulkExportValidationTester

      id :bulk_data_system_export_ndjson_download
      ...
      input :system_export_bulk_download_url

      run do
        ndjson_download_requiresAccessToken_check(bulk_data_download_url: system_export_bulk_download_url, bulk_requires_access_token: system_export_requires_access_token)
      end
    end
  end
end