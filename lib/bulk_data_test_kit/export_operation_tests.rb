...
module BulkDataTestKit
  module BulkDataExportOperationTests
    ...
    def rejects_without_authorization
      skip_if bulk_auth_info.access_token.blank?, 'Bearer token is not set and thus not required to connect to server.'
    ...
    def export_status_check_success(status_polling_url)
      ...
      loop do
        get(status_polling_url, headers: { authorization: "Bearer #{bulk_auth_info.access_token}", accept: 'application/json' })
