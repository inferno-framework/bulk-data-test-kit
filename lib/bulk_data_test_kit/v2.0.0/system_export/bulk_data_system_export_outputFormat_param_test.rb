...
module BulkDataTestKit
  module BulkDataV200
    class BulkDataSystemExportOutputFormatParamTest < Inferno::Test
      ...
      title 'Bulk Data Server supports "_outputFormat" query parameter for the system level export of data'
