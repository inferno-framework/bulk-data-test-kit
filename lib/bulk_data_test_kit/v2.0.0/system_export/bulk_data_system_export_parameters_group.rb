  ...
  module BulkDataV200
    class BulkDataSystemExportParameters < Inferno::TestGroup
      ...
      test from: :output_format_in_export_response,
           ...
           verifies_requirements: ['hl7.fhir.uv.bulkdata_2.0.0@47', 'hl7.fhir.uv.bulkdata_2.0.0@49',
                                   'hl7.fhir.uv.bulkdata_2.0.0@51', 'hl7.fhir.uv.bulkdata_2.0.0@52', 'hl7.fhir.uv.bulkdata_2.0.0@231']
